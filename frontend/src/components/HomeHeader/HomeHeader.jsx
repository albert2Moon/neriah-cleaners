                ...
                <div className="header-container">
                    <div className="header-card1">
                        ...
                        <div className='header-title'>
                            <h1>Your Trusted Cleaning Experts in East Africa</h1>
                            <p>Providing top-notch cleaning solutions for homes and businesses across Kampala, Mpigi, Mukono, and Wakiso.</p></div>
